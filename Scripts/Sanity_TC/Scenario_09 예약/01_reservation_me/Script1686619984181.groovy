...
'기대결과 - 예약 설정 화면으로 이동'
Mobile.verifyElementVisible(findTestObject('11_receipt/txt_description', [('text') : GlobalVariable.user_name]), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //이름
