...
'기대결과 - 마이페이지 로그인 상태 노출'
Mobile.verifyElementText(findTestObject('06_mypage/txt_name_title'), GlobalVariable.user_name, FailureHandling.CONTINUE_ON_FAILURE) //이름
Mobile.verifyElementVisible(findTestObject('06_mypage/btn_edit'), GlobalVariable.fixedTime, FailureHandling.CONTINUE_ON_FAILURE) //[수정] 
//
